...
const page = () => {
  return (
    <div className={styles.main}>
      <h1>Privacy Policy for Cyber Code Hub</h1>
      <Image
        src={
          "https://res.cloudinary.com/dz4z5m7qt/image/upload/v1716821983/privacy-policy-cybercodehub_a2ey1e.jpg"
        }
        alt="Cyber-Code-Hub-privacy-policy"
        width={500}
        height={500}
        className={styles.privImage}
        loading="eager"
        priority={true}
      />
      <p>
        At Cyber Code Hub, accessible from https://www.cybercodehub.com, one of
        ...
        Cyber Code Hub and how we use it.
      </p>
      <p>
      ...
      <h2>Log Files</h2>
      <p>
        Cyber Code Hub follows a standard procedure of using log files. These
      ...
      <p>
        Like any other website, Cyber Code Hub uses "cookies". These cookies are
      ...
      <p>
        ...
        advertising partners of Cyber Code Hub.
      </p>
      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Cyber Code Hub, which are sent
      ...
      <p>
        Note that Cyber Code Hub has no access to or control over these cookies
        that are used by third-party advertisers.
      </p>
      <h2>Third Party Privacy Policies</h2>
      <p>
        Cyber Code Hub's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        Cyber Code Hub does not knowingly collect any Personal Identifiable
      ...
      <p>
        ...
        shared and/or collect in Cyber Code Hub. This policy is not applicable
